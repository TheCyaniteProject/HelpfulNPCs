...
public class ClientSetup {
  ...
  public static final ResourceLocation[] BODIES = {
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/body1.png"),
    // … add more bodies here …
  };

  public static final ResourceLocation[] OUTFITS = {
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/outfit1.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/outfit2.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/outfit3.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/outfit4.png")
  };

  public static final ResourceLocation[] EYES = {
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/eyes1.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/eyes2.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/eyes3.png")
  };

  public static final ResourceLocation[] HAIR = {
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/hair1.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/hair2.png"),
    new ResourceLocation(SimpleWorkers.MODID, "textures/entity/hair3.png")
  };
    ...
    return CACHE.computeIfAbsent(id, i -> {
      try {
        ...
        ResourceLocation loc = new ResourceLocation(
          SimpleWorkers.MODID, "textures/entity/worker_combined_" + id + ".png"
        );
